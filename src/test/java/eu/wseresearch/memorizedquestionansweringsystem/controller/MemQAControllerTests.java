...
import eu.wseresearch.memorizedquestionansweringsystem.Application;
...
class MemQAControllerTests {
    ...
    void testPostResponse() throws Exception {
        ...
        when(mockedMemQASystem.createAnswer(any(String.class), any(String.class), any(Integer.class), any(String.class))).thenReturn(responseJsonObject);
